...
return new class extends Migration
{
    ...
    {
        Schema::create('loan_request_topups', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('loan_request_id');
            $table->unsignedBigInteger('pinjaman_id'); // The existing active loan being refinanced
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('loan_request_topups');
    }
};
