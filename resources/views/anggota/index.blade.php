                    ...
                    <tr onclick="window.location='{{ route('anggota.show', $item) }}'">
                        ...
                        <td>
                            @if($item->status == 'active' || $item->status == 'Aktif')
                                <span style="display:inline-block; padding:2px 8px; border-radius:12px; font-size:11px; background-color:#e6f4ea; color:#137333; font-weight:600;">{{ ucfirst($item->status) }}</span>
                            @else
