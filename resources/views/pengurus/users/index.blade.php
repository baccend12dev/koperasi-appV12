                    ...
                    <tr>
                        ...
                        <td style="text-align: right; padding-right: 16px;" onclick="event.stopPropagation()">
                            <div style="display:inline-flex; gap:6px;">
                                <a href="{{ route('pengurus.users.permissions', $user->id) }}" class="btn-secondary" style="padding: 4px 10px; font-size: 11.5px; font-weight:700; color:#047857; background:#ECFDF5; border-color:#A7F3D0; text-decoration:none; display:inline-flex; align-items:center; gap:4px;">
