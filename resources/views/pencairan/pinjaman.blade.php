...
<div class="sd-section">
    ...
    <form action="{{ route('pencairan.pinjaman') }}" method="GET" class="space-y-1">
        ...
        @if($tahun || $bulan)
            <a href="{{ route('pencairan.pinjaman') }}" class="btn-clear">
...
<div class="stats-grid">
    <div class="stat-card-dark">
        <div class="text-gray-400 text-xs font-bold tracking-wider mb-2">TOTAL PENCAIRAN (NET)</div>
        <div class="text-2xl font-bold text-white">Rp {{ number_format($totalNet, 0, ',', '.') }}</div>
    ...
    <div class="stat-card-light">
        <div class="text-xs font-bold tracking-wider text-indigo-600 mb-1">BRUTO PINJAMAN</div>
        <div class="text-2xl font-bold text-indigo-700">Rp {{ number_format($totalPinjaman, 0, ',', '.') }}</div>
    ...
    <div class="stat-card-light">
        <div class="text-xs font-bold tracking-wider text-orange-600 mb-1">DIPOTONG PELUNASAN</div>
        <div class="text-2xl font-bold text-orange-600">Rp {{ number_format($totalPotongan, 0, ',', '.') }}</div>
        <div class="absolute right-5 top-1/2 -translate-y-1/2 bg-orange-50 p-3 rounded-xl">
